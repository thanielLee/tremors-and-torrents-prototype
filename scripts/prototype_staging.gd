@tool
class_name PrototypeStaging
extends XRToolsStaging

## Made by Marco Gimena
# This is a custom script using the staging system in XRTools
# made for the prototype
...
var control_pad_hand: String = "LEFT" # still not used
...
func _on_scene_loaded(scene: Variant, user_data: Variant) -> void:
	# from inherited scene
	prompt_for_continue = false
	scene_is_loaded = true


func _on_scene_exiting(scene: Variant, user_data: Variant) -> void:
